// Carta elaborada y extraída desde NotebookLM
window.menuData = [
  {
    "nombre": "CROQUETA DE LECHE DE OVEJA E IBÉRICO DE BELLOTA",
    "precio": 3.00,
    "alergenos": [
      "Gluten",
      "Lácteo",
    ...
    "foto": "Croqueta de Jamón Ibérico.png",
    "descripcion": "Croqueta Finalista del Concurso Nacional MADRID FUSIÓN 2023. Empleamos leche de Oveja para obtener una mayor cremosidad y Jamón ibérico de Bellota. Aceite Extra virgen de Oliva para una fritura perfecta llena de sabor y equilibrio. Pueden pedirse por unidades o ración de 8 unidades."
  },
  {
    "nombre": "CRUJIENTE DE BACALAO AL AJO ARRIERO",
    "precio": 3.00,
    "alergenos": [
      "Pescado",
      "Gluten",
  ...
  {
    "nombre": "ANCHOA 00, NARANJA Y ALBAHACA",
    "precio": 3.00,
    "alergenos": [
      "Pescado"
    ],
  ...
  {
    "nombre": "LOMO DE SARDINA MARINADA EN BLANCO",
    "precio": 3.00,
    "alergenos": [
      "Pescado",
      "Soja",
  ...
  {
    "nombre": "ALBÓNDIGA DE CIERVO, TARTUFATA Y PARMENTIER DE ZANAHORIA",
    "precio": 3.00,
    "alergenos": [
      "Gluten",
      "Lácteo",
  ...
  {
    "nombre": "ALCACHOFAS SALTEADAS, CREMA DE BOLETUS Y YEMA CURADA CON FURIKAKE",
    "precio": 17.00,
    "alergenos": [
      "Huevo",
      "Lácteos",
    ...
    "opciones_sin_gluten": true,
    "categoria": "entrante",
    "foto": "Alcachofas, yema, Boletus.png",
    "descripcion": "Un auténtico festival de umami y texturas. Tiernos corazones de alcachofa cuidadosamente salteados hasta alcanzar el punto perfecto de dorado, reposando sobre una envolvente y aromática crema de boletus. Lo coronamos con la untuosidad de una yema curada y el toque sorprendente del furikake japonés, que aporta un contraste crujiente y salino fascinante"
  },
  {
    "nombre": "CANELÓN DE MORTERUELO (2 UNID), FOIE Y JUGO DE RATAFIA",
    "precio": 15.00,
    "alergenos": [
      "Gluten",
      "Sulfitos",
    ...
    "opciones_sin_gluten": false,
    "categoria": "entrante",
    "foto": "Canelon de morteruelo.png",
    "descripcion": "La tradición manchega elevada a su máxima expresión. Fina pasta rellena de un meloso morteruelo de caza menor, afinado con la delicadeza del foie. Se presenta bañado en una sedosa salsa de foie y fondo oscuro de caza, culminado con un sutil chorrito de jugo de ratafía que aporta el inconfundible matiz de los frutos secos . (Aviso: Caza silvestre, ocasionalmente puede contener algún perdigón)."
  },
  {
    "nombre": "ENSALADILLA TRADICIONAL CON VENTRESCA DE ATÚN",
    "precio": 16.00,
    "alergenos": [
      "Pescado",
      "Huevo",
  ...
  {
    "nombre": "BERENJENA ASADA AL MISO, REQUESÓN Y TRUCHA MARINADA",
    "precio": 16.50,
    "alergenos": [
      "Soja",
      "Sulfitos",
  ...
  {
    "nombre": "ENSALADA DE PERDIZ, EMULSIÓN DE ESCABECHE, MENTA Y CEBOLLA",
    "precio": 15.00,
    "alergenos": [
      "Frutos Secos",
      "Sulfitos"
  ...
  {
    "nombre": "ALBÓNDIGAS DE CIERVO, TARTUFATA Y PARMENTIER DE ZANAHORIA",
    "precio": 20.00,
    "alergenos": [
      "Gluten",
      "Lácteo",
  ...
  {
    "nombre": "ARROZ MELOSO DE CHANGURRO, AMERICANA DE MORCILLA Y AZAFRÁN",
    "precio": 23.00,
    "alergenos": [
      "Moluscos",
      "Pescado",
  ...
  {
    "nombre": "CARRILLERA DE ATÚN ROJO, APIO NABO Y TIRABEQUES",
    "precio": 27.00,
    "alergenos": [
      "Pescado",
      "Sulfitos",
    ...
    "opciones_sin_gluten": true,
    "categoria": "principal",
    "foto": "carrillada Atún Rojo.png",
    "descripcion": "El 'solomillo del mar' en su máxima expresión. Melosa y jugosa carrillera de atún rojo guisada a fuego lento, glaseada en un jugo oscuro, brillante y profundo con sutiles matices asiáticos. Para equilibrar tanta intensidad, la acompañamos con una sedosa crema de apionabo y el frescor crujiente de los tirabeques cortados finamente."
  },
  {
    "nombre": "STEAK TARTAR DE WAGYU SOBRE TUETANO",
    "precio": 25.00,
    "alergenos": [
      "Sulfitos",
      "Soja",
  ...
  {
    "nombre": "PRESA IBÉRICA ADOBADA, JUGO DE CAFÉ, SETAS SHITAKE Y HUMMUS",
    "precio": 24.00,
    "alergenos": [
      "Moluscos",
      "Sulfitos",
  ...
  {
    "nombre": "COCHINILLO DESHUESADO A BAJA TEMPERATURA, SU JUGO Y TEXTURAS DE BERENJENA",
    "precio": 28.00,
    "alergenos": [
      "Soja",
      "Sulfitos",
  ...
  {
    "nombre": "PULPO, MOJETE MANCHEGO Y PATATA A LAS HIERBAS",
    "precio": 27.00,
    "alergenos": [
      "Pescado",
      "Sulfitos"
    ...
    "categoria": "principal",
    "foto": "Pulpo.png",
    "descripcion": "Color, brasa y tradición. La intensidad y textura del pulpo asado contrasta visual y gustativamente con la frescura herbácea de la patata. El toque final del mojete manchego despierta el paladar y redondea el conjunto"
  },
  {
    "nombre": "BACALAO EN TEMPURA DE TRISOL, TIZNAO Y EMULSIÓN DE CEBOLLINO",
    "precio": 26.00,
    "alergenos": [
      "Pescado",
      "Gluten",
  ...
  {
    "nombre": "LOMO DE CIERVO, MOLE Y MILHOJAS DE QUESO MANCHEGO Y PATATA",
    "precio": 27.00,
    "alergenos": [
      "Sulfitos",
      "Soja",
    ...
    "opciones_sin_gluten": true,
    "categoria": "principal",
    "foto": "Lomo Ciervo.png",
    "descripcion": "Una fusión magistral entre el monte toledano y aromas de ultramar. Exquisito lomo de ciervo, tierno y de sabor profundo, bañado en un mole complejo y rico en matices tostados. Lo acompaña un delicado y crujiente milhojas de patata con queso manchego, que aporta la cremosidad ideal para equilibrar el plato"
  },
  {
    "nombre": "CARRILLADA DE JABALÍ, CREMA DE CEBOLLA Y ALMENDRA",
    "precio": 24.00,
    "alergenos": [
      "Sulfitos",
      "Soja",
    ...
    "opciones_sin_gluten": false,
    "categoria": "principal",
    "foto": "carrillada jabali.png",
    "descripcion": "El sabor más auténtico de nuestra sierra. Jugosas carrilladas de jabalí guisadas pacientemente a fuego lento hasta deshacerse en el paladar. Las acompañamos con una delicada crema de cebolla y almendra que aporta una suavidad sedosa, equilibrando la intensidad de la caza con notas dulces y tostadas."
  },
  {
    "nombre": "POCHAS ESTOFADAS CON PERDIZ",
    "precio": 20.00,
    "alergenos": [
      "Sulfitos",
      "Soja",
    ...
    "opciones_sin_gluten": true,
    "categoria": "principal",
    "foto": "Pochas con Perdiz.png",
    "descripcion": "Un homenaje a la cuchara tradicional y a la caza de nuestra tierra. Pochas mantecosas estofadas a fuego lento en un caldo profundo y lleno de sabor, acompañadas de perdiz desmigada para garantizar la máxima melosidad. Lo coronamos con un bocado noble de la propia perdiz, marcado a la plancha, y un toque de cebollino fresco. Pura reconfortante elegancia"
  },
  {
    "nombre": "RUIBARBO, HELADO DE ROSAS, TIERRA DE LECHE Y YOGURT",
    "precio": 7.00,
    "alergenos": [
      "Leche",
      "Huevos"
  ...
  {
    "nombre": "TARTA DE QUESO MANCHEGO Y HELADO DE MIEL",
    "precio": 9.00,
    "alergenos": [
      "Huevos",
      "Leche",
    ...
    "opciones_sin_gluten": false,
    "categoria": "postre",
    "foto": "Tarta queso.png",
    "descripcion": "Descubre por qué ha sido galardonada como la Mejor Tarta de Queso Manchego 2023. Una elaboración de textura fundente y sabor profundo que rinde homenaje a nuestro queso más ilustre. La acompañamos con un delicado helado de miel de la zona, recreando la combinación clásica de nuestra tierra en un formato de alta repostería"
  },
  {
    "nombre": "TORRIJA DE PAN BRIOCHE, TOFFE Y HELADO DE CAFÉ",
    "precio": 9.00,
    "alergenos": [
      "Huevos",
      "Leche",
    ...
    "opciones_sin_gluten": false,
    "categoria": "postre",
    "foto": "Torrija de pan Brioche.png",
    "descripcion": "Nuestra versión más golosa de un clásico. Partimos de un tierno pan brioche artesano, infusionado pacientemente para lograr una textura sedosa que se deshace en la boca. La servimos con un suave toffee casero y la intensidad de un helado de café de selección, creando un contraste térmico y de sabor irresistible"
  },
  {
    "nombre": "CÚPULA DE CHOCOLATE, FRUTOS SECOS Y FRAMBUESA",
    "precio": 8.50,
    "alergenos": [
      "Huevos",
      "Leche",
